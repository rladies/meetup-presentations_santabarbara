...
[(read actual information here)](https://github.com/R-Meetup-SB/hackathon-201806/blob/master/mob-programming.Rmd)
...
Data are sourced from the National Park Service: [irma.nps.gov/Stats/SSRSReports](https://irma.nps.gov/Stats/SSRSReports)) . 
