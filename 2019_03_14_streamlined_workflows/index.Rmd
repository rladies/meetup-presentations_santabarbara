...
author: "RLadies Santa Barbara: @RLadiesSB"
date: "`r Sys.Date()`"
output:
...
3. Organize work into Projects
  - Use an IDE
  - Name files welldeliberately Rilepaths (reprise)  
4. (Bonus) `usethis`
  - Configure git
...
- the more deliberate you are about where things live, 
  ...
  - the easier it will be for future you
...
But eventually I admitted that this *did* cause me grief whenever I moved my files, collaborated on an analysis with a colleague, or got a new computer.You can design this particular aggravation out of your life.

Caveat from [Jenny's original blog post about this](https://www.tidyverse.org/articles/2017/12/workflow-vs-script/): only you can decide how much you care about this. The importance of these practices has a lot to do with whether your code will be run by other people, on other machines, and in the future. If your current practices serve your purposes, then go forth and be happy.
...
```{r xx, out.width = '40%', fig.align='center', echo = FALSE}
knitr::include_graphics("images/project-org-bhi.png") 
```
